...
<head>
    ...
    <title>Advanced Search Query Builder</title>
</head>
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-4xl mx-auto">
        ...
        <div class="mt-4">
            <div class="flex items-center space-x-4">
                ...
                <input
                    type="text"
                    placeholder="Example: liver disease india singh"
        ...
        <div class="mt-8">
            ...
            <p class="text-gray-500">Your history is currently empty. All your searches in the current session will appear here.</p>
        </div>
    </div>
</body>
</html>