    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                ...
                <p class="ml-6"> <span class="font-medium text-green-400">Description: </span>The ayah you want to
                    find. It is a combination of surah_id and ayah_index. (e.g. 1:1)</p>
                <p class="ml-6"> <span class="font-medium text-green-400">Notes: </span>Make sure the surah_id and
    ...
    <div class="my-10">
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set
                    translations query parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
