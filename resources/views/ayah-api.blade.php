<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    <h1 class="font-bold my-5 text-2xl">Ayah API</h1>
    <div class="my-10">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                ...
                <p class="ml-6"> <span class="font-medium text-black">Description: </span>The ayah you want to
                    find. It is a combination of surah_id and ayah_index. (e.g. 1:1)</p>
                <p class="ml-6"> <span class="font-medium text-black">Notes: </span>Make sure the surah_id and
                    ayah_index are separated by ':'. Also, you may exclude the
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the
                    words query parameter to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set
                    translations query parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
    ...
    <div class="my-10">
        ...
        <div x-show="responseOpen" x-transition class="my-2 ml-6" x-data="{ surahOpen: false, surahInfoOpen: false, ayahOpen: false, wordOpen: false, translationInfoOpen: false, translationOpen: false, tafseerInfoOpen: false, tafseerOpen: false, audioRecitationInfoOpen: false, audioRecitationOpen: false, audioRecitationInfoTranslatedNameOpen: false, tafseerInfoTranslatedNameOpen: false }">
            <div @click="ayahOpen = !ayahOpen" class="cursor-pointer rounded-md flex gap-3 items-center text-black">
