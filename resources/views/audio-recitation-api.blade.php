<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    <h1 class="font-bold my-5 text-2xl">Audio Recitation API</h1>
    <div class="my-10">
    ...
    <div class="my-10">
        ...
        <p>/audio_recitations/:ayah_key</p>
    </div>
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">ayah_key <span
                ...
                <p class="ml-6"> <span class="font-medium text-black">Description: </span>The ayah which you want
                    to find its audio recitation. It is a combination of surah_id and ayah_index. (e.g. 1:1)</p>
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the
                    audio_recitation_info query parameters to true in order for this parameter to
                    work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">surah</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load the surah for
                    that adio recitation.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
            </div>
            <div class="my-5">
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">ayah</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load the ayah for that
                    audio recitation.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
            </div>
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the ayah query
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load all of the words
                    for
                    that ayah.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set ayah query
                    parameter to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the ayah and
                    translations query
                    parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the ayah,
                    translations, and
                    translation_info query parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load the tafseer info
                    of the tafseer.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set ayah and
                    tafseers query parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
    ...
    <div class="my-10">
        ...
        <div x-show="responseOpen" x-transition class="my-2 ml-6" x-data="{ surahOpen: false, surahInfoOpen: false, ayahOpen: false, wordOpen: false, translationInfoOpen: false, translationOpen: false, tafseerInfoOpen: false, tafseerOpen: false, audioRecitationInfoOpen: false, audioRecitationOpen: false, audioRecitationInfoTranslatedNameOpen: false, tafseerInfoTranslatedNameOpen: false }">
            <div @click="audioRecitationOpen = !audioRecitationOpen"
                ...
                <svg :class="{ 'rotate-90': audioRecitationOpen, 'rotate-0': !audioRecitationOpen }" x-transition
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.5"
                    stroke="currentColor" class="size-4 transition-transform duration-300">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                </svg>
