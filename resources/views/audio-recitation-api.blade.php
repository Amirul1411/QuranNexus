<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">ayah_key <span
                        class="font-normal text-gray-400">string </span><span class="text-red-500">required</span></p>
                <p class="ml-6"> <span class="font-medium text-green-400">Description: </span>The ayah which you want
                    to find its audio recitation. It is a combination of surah_id and ayah_index. (e.g. 1:1)</p>
                <p class="ml-6"> <span class="font-medium text-green-400">Notes: </span>Notes: Make sure the surah_id
    ...
    <div class="my-10">
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Load the surah for
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set the surah
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Load the ayah for that
                    audio recitation.</p>
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[true, false]</p>
            </div>
            <div class="my-5">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Load all of the words
                    for
                    that ayah.</p>
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[true, false]</p>
