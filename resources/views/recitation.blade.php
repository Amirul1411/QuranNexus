<x-app-layout title="Surah List">
    ...
    <div class="w-full mx-32">
        <div class="flex justify-center my-3 mt-32">
            <div x-data="{ activeOption: 'byAyat' }" class="bg-black rounded-full flex my-5">
                ...
                <label :class="activeOption === 'byAyat' ? 'bg-gray-600' : 'bg-transparent'"
                    ...
                    for="byAyat" @click="$dispatch('set-page-layout', 'byAyat')"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div x-data="{ layout: 'byAyat' }" @set-page-layout.window="layout = $event.detail" class="h-auto">
            <template x-if=" layout === 'byAyat' ">
