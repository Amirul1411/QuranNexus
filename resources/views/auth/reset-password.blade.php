...
<x-app-layout title="Reset Password" backgroundImage="background-image">
    <div class="w-full my-4">
        <x-authentication-card background="bg-transparent">
            ...
            <h2 class="text-center text-3xl my-5 text-black font-medium">Reset Password</h2>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="my-7 relative w-full justify-center flex">
                    ...
                    <x-input id="email" class="block mt-1 w-full font-semibold pl-12 z-0 h-[40px]" rounded="rounded-full" darkBg=""
                    darkText="dark:text-black" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="E-mail"/>
                ...
                <div class="my-7 relative w-full justify-center flex" x-data="{ showPassword: false }">
                    ...
                    <x-input rounded="rounded-full" darkBg="" darkText="dark:text-black" x-bind:type="showPassword ? 'text' : 'password'" id="password" class="block mt-1 w-full font-semibold pl-12 z-0" type="password" name="password" required autocomplete="new-password"
                ...
                <div class="my-7 relative w-full justify-center flex" x-data="{ showPassword: false }">
                    ...
                    <x-input rounded="rounded-full" darkBg="" darkText="dark:text-black" x-bind:type="showPassword ? 'text' : 'password'" id="password_confirmation" class="block mt-1 w-full font-semibold pl-12 z-0" type="password" name="password_confirmation" required autocomplete="new-password"
