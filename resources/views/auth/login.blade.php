...
<x-app-layout title="Login" backgroundImage="background-image">
    <div class="w-full my-4">
        <x-authentication-card background="bg-transparent">
            ...
            <h2 class="text-center text-3xl my-5 text-black font-medium">Login</h2>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="my-7 relative w-full justify-center flex">
                    ...
                    <x-input rounded="rounded-full" darkBg="" darkText="dark:text-black" id="email"
                        class="block mt-1 z-0 w-full font-semibold pl-12" type="email" name="email"
                ...
                <div class="flex justify-between mt-4">
                    ...
                    @if (Route::has('password.request'))
                        <a class=" cursor-pointer font-semibold text-sm text-gray-400 dark:text-gray-400 hover:text-gray-100 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-800 dark:focus:ring-offset-gray-800"
            ...
            <div class="flex gap-3 justify-center my-4">
                <h2 class="text-base text-black font-sans font-semibold me-3">Doesn't have an account yet?</h2>
                <a class="cursor-pointer text-base font-sans font-semibold text-[#63FFDA] hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                href="{{ route('register') }}">
                Create one</a>
            </div>
