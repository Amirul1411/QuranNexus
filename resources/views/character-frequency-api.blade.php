<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    <h1 class="font-bold my-5 text-2xl">Character Frequency API</h1>
    <div class="my-10">
    ...
    <div class="my-10">
        ...
        <p>/character_frequency/:character_frequency_id</p>
    </div>
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">character_frequency_id <span
                ...
                <p class="ml-6"> <span class="font-medium text-black">Description: </span>The id of the
                    character frequency you want to retrieve.
                </p>
                <p class="ml-6"> <span class="font-medium text-black">Notes: </span>You may exclude the
                    '/:character_frequency_id' from the url if you want to get
                    all character frequency.</p>
            </div>
        </div>
    </div>
    <div class="my-10">
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value of the
                    character frequency fields that are required by the user if the user only want to retrieve some of
                    the character frequency fields. (e.g. Id,Character,Count, ...)
                </p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[Id, Character,
                    Count, Locations]</p>
            </div>
        </div>
    </div>
    <div class="my-10">
        ...
        <div x-show="responseOpen" x-transition class="my-2 ml-6" x-data="{ characterFrequencyOpen: false, characterFrequencyLocationsOpen: false }">
            <div @click="characterFrequencyOpen = !characterFrequencyOpen"
                class="cursor-pointer rounded-md flex gap-3 items-center text-black ml-6">
                <svg :class="{ 'rotate-90': characterFrequencyOpen, 'rotate-0': !characterFrequencyOpen }" x-transition
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.5"
                    stroke="currentColor" class="size-4 transition-transform duration-300">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                </svg>
                <p class="rounded-md px-2 inline-block font-medium">Character Frequency <span
                        class="font-normal text-gray-500">object</span></p>
            </div>
            <div x-show="characterFrequencyOpen" x-transition class="ml-6">
                <p class="rounded-md px-2 font-medium text-black ml-6">Id <span
                        class="font-normal text-gray-500">string</span></p>
                <p class="rounded-md px-2 font-medium text-black ml-6">Character <span
                        class="font-normal text-gray-500">string</span></p>
                <p class="rounded-md px-2 font-medium text-black ml-6">Count <span
                        class="font-normal text-gray-500">integer</span></p>
                <div @click="characterFrequencyLocationsOpen = !characterFrequencyLocationsOpen"
                    class="cursor-pointer rounded-md flex gap-3 items-center text-black ml-6">
                    <svg :class="{
                        'rotate-90': characterFrequencyLocationsOpen,
                        'rotate-0': !
                            characterFrequencyLocationsOpen
                    }"
                ...
                <div x-show="characterFrequencyLocationsOpen" x-transition class="ml-6">
