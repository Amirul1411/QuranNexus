<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">surah_id <span
                        class="font-normal text-gray-400">string </span><span class="text-red-500">required</span></p>
                <p class="ml-6"> <span class="font-medium text-green-400">Description: </span>The ID of the surah</p>
                <p class="ml-6"> <span class="font-medium text-green-400">Possible values: </span>1-114</p>
    ...
    <div class="my-10">
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set the surah_info
                    query parameter to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">ayahs</p>
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Load all of the ayahs for
                    that surah.</p>
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[true, false]</p>
            </div>
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[Id, Surah Id, Ayah Index, Ayah
                    Key, Page Id, Juz Id, Bismillah]</p>
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set the ayahs query
                    parameter to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">words</p>
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Load all of the words for
                    that ayah.</p>
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set ayahs query
                    parameter to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">word_fields</p>
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Comma separated value of
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set the ayahs and
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set ayahs and
                    translations query parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Notes: </span>You must set the ayahs,
    ...
    <div class="my-10">
        ...
        <div x-show="responseOpen" x-transition class="my-2 ml-6" x-data="{ surahOpen: false, surahInfoOpen: false, ayahOpen: false, wordOpen: false, translationInfoOpen: false, translationOpen: false, tafseerInfoOpen: false, tafseerOpen: false, audioRecitationInfoOpen: false, audioRecitationOpen: false, audioRecitationInfoTranslatedNameOpen: false, tafseerInfoTranslatedNameOpen: false }">
            <div @click="surahOpen = !surahOpen"
                class="cursor-pointer rounded-md flex gap-3 items-center text-green-400">
            ...
            <div x-show="surahOpen" x-transition class="ml-6">
                <p class="rounded-md px-2 font-medium text-green-400">Id <span
                        class="font-normal text-gray-400">string</span></p>
                <p class="rounded-md px-2 font-medium text-green-400">Arabic Name <span
                        class="font-normal text-gray-400">string</span></p>
                <p class="rounded-md px-2 font-medium text-green-400">Name <span
                        class="font-normal text-gray-400">string</span></p>
                <p class="rounded-md px-2 font-medium text-green-400">Name Meaning <span
                        class="font-normal text-gray-400">string</span></p>
                <p class="rounded-md px-2 font-medium text-green-400">Type <span
                        class="font-normal text-gray-400">string</span></p>
                <p class="rounded-md px-2 font-medium text-green-400">Number of Ayahs <span
