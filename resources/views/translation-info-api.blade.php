<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">translation_id <span
                ...
                <p class="ml-6"> <span class="font-medium text-green-400">Possible values: </span>[1 - Basmeih
                    (Malay),
