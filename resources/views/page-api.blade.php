<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">page_id <span
                        class="font-normal text-gray-500">integer </span><span class="text-red-500">required</span></p>
                <p class="ml-6"> <span class="font-medium text-black">Description: </span>The id of the page you
                    want to retrieve.
                </p>
                <p class="ml-6"> <span class="font-medium text-black">Possible values: </span>1-604</p>
                <p class="ml-6"> <span class="font-medium text-black">Notes: </span>You may exclude the
                    '/:page_id' from the url if you want to get
                    all pages.</p>
            </div>
        </div>
    </div>
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value of
                    the page fields that are required by the user if the user only want to retrieve some of the page
    ...
    <div class="my-10">
        ...
        <div x-show="responseOpen" x-transition class="my-2 ml-6" x-data="{ surahOpen: false, surahInfoOpen: false, ayahOpen: false, wordOpen: false, translationInfoOpen: false, translationOpen: false, tafseerInfoOpen: false, tafseerOpen: false, audioRecitationInfoOpen: false, audioRecitationOpen: false, audioRecitationInfoTranslatedNameOpen: false, tafseerInfoTranslatedNameOpen: false, pageOpen: false }">
            <div @click="pageOpen = !pageOpen"
                ...
                <p class="rounded-md px-2 inline-block font-medium">Page <span
                        class="font-normal text-gray-500">object</span></p>
            </div>
            <div x-show="pageOpen" x-transition>
