...
@section('title', 'Word by Word Verification')
        ...
        @if ($word)
            ...
            <form id="navigation-form" action="{{ route('word.index') }}" method="GET" class="mb-6">
                <div class="flex justify-center space-x-4 items-center">
                    <!-- Surah Dropdown -->
                    <select name="surah_id" id="surah-dropdown" class="p-2 rounded border border-gray-300 focus:ring focus:ring-[#4CAF50]">
                    ...
                    <!-- Ayah Dropdown -->
                    <select name="ayah_index" id="ayah-dropdown" class="p-2 rounded border border-gray-300 focus:ring focus:ring-[#4CAF50]">
                    ...
                    <!-- Word Dropdown -->
                    <select name="word_index" id="word-dropdown" class="p-2 rounded border border-gray-300 focus:ring focus:ring-[#4CAF50]">
            ...
            <form action="{{ route('word.verify', ['wordKey' => $word->word_key]) }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="flex justify-between items-center">
                    <!-- Next Button -->
                    <a href="{{ route('word.next', ['wordKey' => $word->word_key]) }}" class="bg-blue-500 text-white px-6 py-2 rounded shadow hover:bg-blue-600">
                        Next
                    </a>
                    <!-- Verify Button -->
                    ...
                    <!-- Back Button -->
                    <a href="{{ route('word.back', ['wordKey' => $word->word_key]) }}" class="bg-gray-500 text-white px-6 py-2 rounded shadow hover:bg-gray-600">
                        Back
                    </a>
                </div>
            </form>
