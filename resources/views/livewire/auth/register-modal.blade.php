    ...
    <x-slot name="content">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="my-7 relative w-full justify-center flex" x-data="{ showPassword: false }">
                <x-input rounded="rounded-full" darkBg="" darkText="dark:text-black" id="password" x-bind:type="showPassword ? 'text' : 'password'"
                    class="block mt-1 w-full font-semibold pl-12 z-0" type="password" name="password" required autocomplete="new-password" placeholder="Password"/>
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500 z-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6 text-black">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="my-7 relative w-full justify-center flex" x-data="{ showPassword: false }">
                <x-input rounded="rounded-full" darkBg="" darkText="dark:text-black" id="password_confirmation" x-bind:type="showPassword ? 'text' : 'password'"
                    class="block mt-1 w-full font-semibold pl-12 z-0" type="password" name="password_confirmation" required
