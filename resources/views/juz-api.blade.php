<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    <h1 class="font-bold my-5 text-2xl">Juz API</h1>
    <div class="my-10">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">juz_id <span
                        class="font-normal text-gray-500">integer </span><span class="text-red-500">required</span></p>
                <p class="ml-6"> <span class="font-medium text-black">Description: </span>The id of the juz you
                    want to retrieve.
                </p>
                <p class="ml-6"> <span class="font-medium text-black">Possible values: </span>1-30</p>
                <p class="ml-6"> <span class="font-medium text-black">Notes: </span>You may exclude the
                    '/:juz_id' from the url if you want to get
                    all juzs.</p>
            </div>
        </div>
    </div>
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value of
                    the juz fields that are required by the user if the user only want to retrieve some of the juz
                    fields. (e.g. Id,Surah Id,Ayah Index, ...)
                </p>
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">surah_info</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load the surah info for
                    that surah.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the surah query
                    parameter to true in order for this parameter to work.</p>
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">surah_info_fields</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value of
                ...
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[Id, Html]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the surah and
                    surah_info
                    query parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">ayahs</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load all of the ayahs for
                    that juz.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">ayah_fields</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value of
                ...
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the ayahs query
                    parameter to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">words</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load all of the words for
                    that ayah.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set ayahs query
                    parameter to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">word_fields</p>
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">translation_info</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load the translation
                    info of the translation.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set ayahs and
                    translations query parameters to true in order for this parameter to work.</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">translation_info_fields</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value
                ...
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set the ayahs,
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">tafseer_info</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load the tafseer info
                    of the tafseer.</p>
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[true, false]</p>
                <p class="ml-6"><span class="font-medium text-black">Notes: </span>You must set ayahs and
                    tafseers query parameters to true in order for this parameter to work.</p>
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">tafseer_info_fields</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value
            ...
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load all of the audio
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">audio_recitation_info</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Load the audio
            ...
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-black">audio_recitation_info_fields</p>
                <p class="ml-6"><span class="font-medium text-black">Description: </span>Comma separated value
                ...
                <p class="ml-6"><span class="font-medium text-black">Possible values: </span>[Id, Reciter Name,
    ...
    <div class="my-10">
        ...
        <div x-show="responseOpen" x-transition class="my-2 ml-6" x-data="{ surahOpen: false, surahInfoOpen: false, ayahOpen: false, wordOpen: false, translationInfoOpen: false, translationOpen: false, tafseerInfoOpen: false, tafseerOpen: false, audioRecitationInfoOpen: false, audioRecitationOpen: false, audioRecitationInfoTranslatedNameOpen: false, tafseerInfoTranslatedNameOpen: false, juzOpen: false }">
            <div @click="juzOpen = !juzOpen" class="cursor-pointer rounded-md flex gap-3 items-center text-black">
                <svg :class="{ 'rotate-90': juzOpen, 'rotate-0': !juzOpen }" x-transition
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3.5"
                    stroke="currentColor" class="size-4 transition-transform duration-300">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                </svg>
                <p class="rounded-md px-2 inline-block font-medium">Juz <span
                        class="font-normal text-gray-500">object</span></p>
            </div>
            <div x-show="juzOpen" x-transition>
                ...
                <div x-show="ayahOpen" x-transition class="ml-6">
                    ...
                    <p class="rounded-md px-2 font-medium text-black ml-6">Juz Id <span
                            class="font-normal text-gray-500">string</span></p>
                    <p class="rounded-md px-2 font-medium text-black ml-6">Bismillah <span
                            class="font-normal text-gray-500">string</span></p>
                    ...
                    <div x-show="wordOpen" x-transition class="ml-6">
                        ...
                        <p class="rounded-md px-2 font-medium text-black ml-6">Surah Id <span
                                class="font-normal text-gray-500">string</span></p>
                        <p class="rounded-md px-2 font-medium text-black ml-6">Ayah Idex <span
                                class="font-normal text-gray-500">string</span></p>
                    ...
                    <div x-show="tafseerOpen" x-transition class="ml-6">
                        ...
                        <div x-show="tafseerInfoOpen" x-transition class="ml-6">
                            ...
                            text-black ml-6">Id
                                <span class="font-normal text-gray-500">string</span>
                            </p>
                            <p class="rounded-md px-2 font-medium text-black ml-6">Name <span
                                    class="font-normal text-gray-500">string</span></p>
