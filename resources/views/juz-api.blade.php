<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">juz_id <span
                        class="font-normal text-gray-400">integer </span><span class="text-red-500">required</span></p>
                <p class="ml-6"> <span class="font-medium text-green-400">Description: </span>The id of the juz you
                    want to retrieve.
                </p>
                <p class="ml-6"> <span class="font-medium text-green-400">Possible values: </span>1-30</p>
