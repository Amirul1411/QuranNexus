<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    ...
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">reciter_id <span
                        class="font-normal text-gray-400">string </span><span class="text-red-500">required</span></p>
                <p class="ml-6"> <span class="font-medium text-green-400">Description: </span>The id of the audio recitation you want to retrieve.
                </p>
                <p class="ml-6"> <span class="font-medium text-green-400">Possible values: </span>[1 - Mishari Rashid al-`Afasy,
    ...
    <div class="my-10">
        ...
        <div x-show="queryParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                ...
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Comma separated value of the audio recitation info fields that are required by the user if the user only want to retrieve some of the audio recitation info fields. (e.g. Id,Reciter Name, ...)

                </p>
                <p class="ml-6"><span class="font-medium text-green-400">Possible values: </span>[Id, Reciter Name, Style, Translated Name]</p>
            </div>
            <div class="my-5">
                <p class="rounded-md px-2 inline-block font-medium text-green-400">audio_recitations</p>
                <p class="ml-6"><span class="font-medium text-green-400">Description: </span>Load all of the audio recitations for that reciter's id.</p>
