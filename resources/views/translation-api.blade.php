<div x-data="{ pathParamsOpen: false, queryParamsOpen: false, responseOpen: false }">
    <h1 class="font-bold my-5 text-2xl">Translation API</h1>
    <div class="my-10">
        ...
        <div x-show="pathParamsOpen" x-transition class="my-2 ml-6">
            <div class="my-5">
                ...
                <p class="ml-6"> <span class="font-medium text-black">Description: </span>The ayah which you want
                    to find its translation. It is a combination of surah_id and ayah_index. (e.g. 1:1)</p>
